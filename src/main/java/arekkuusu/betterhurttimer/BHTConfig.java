    ...
    public static class Values {
        ...
        public static class DamageFrames {
            ...
            @Config.Comment("Damage sources that need a specific iFrame." +
                    ...
                    "\n\nOr [*Damage Source name (Regex)]:[*Should damage stack between iFrames]:[*Should be separate]:[*iFrame time]" +
                    ...
                    "\n* Should be separate (Optional) -> 'true' or 'false', If the Damage Source name maps to multiple sources and this is true, they will not share frames." +
                    ...
                    "\n- inFire|lava:false:true:10 -> Sources 'inFire' or 'lava' do not stack and only allows hits every 10 game ticks (lava and fire will NOT share the same iFrame)." +
